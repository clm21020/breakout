(function() {
  ...
  Ball.prototype.hitPaddle = function(paddle) {
    var xOverlap = this.xOverlap(paddle);
    var yOverlap = this.yOverlap(paddle);

    if (xOverlap && yOverlap) {
      this.paddleBounce(paddle, yOverlap);
      return true;
    }
    return false;
  };
  ...
  Ball.prototype.hitBrick = function(brick) {
    var xOverlap = this.xOverlap(brick);
    var yOverlap = this.yOverlap(brick);
